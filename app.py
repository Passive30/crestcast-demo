...
cols[4].metric(label="📊 5-Year Windows", value="89%")
cols[5].metric(label="📉 3-Year Windows", value="73%")
...
cols[4].metric(label="📊 5-Year Windows", value="76%")
cols[6].metric(label="📉 3-Year Windows", value="60%")
