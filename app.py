...
if show_relative_perf:
    ...
    crest_rolling_ann = net_crestcast.rolling(window=36).apply(lambda r: (1 + r).prod()**(1/3) - 1)
    bench_rolling_ann = benchmark.rolling(window=36).apply(lambda r: (1 + r).prod()**(1/3) - 1)
